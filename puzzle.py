...
knowledge0 = And(
    Not(And(AKnight, AKnave)), #can't be both knight and knave
...
knowledge2 = And(
    ...
    Or(And(BKnight, Or(And(BKnight, AKnave), And(AKnight, BKnave))), And(BKnave, Or(And(AKnight, BKnight), And(BKnave, AKnave)))),
)
